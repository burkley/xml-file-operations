...
//		try {
//			throw new Exception("FGB Test PPL...");
//		}catch (Exception e) {
//			e.printStackTrace();
//		}
	}
	...
	public void actionPerformed(ActionEvent event) {
		...
		PrettyPrintSwingWorker worker = new PrettyPrintSwingWorker();
		worker.execute();
	 ...
	 *
	 */
	class PrettyPrintSwingWorker extends SwingWorker<String, String> {
...
//					System.out.println(this.getClass().getName() + ".doInBackground(): " + msg.toString());
		...
		protected void process(List<String> chunks) {
			...
			for (String chunk : chunks) {
				PrettyPrintListener.this.resultsTextArea.append(chunk);
				PrettyPrintListener.this.resultsTextArea.setCaretPosition(PrettyPrintListener.this.resultsTextArea.getDocument().getLength());				
			}
		}
