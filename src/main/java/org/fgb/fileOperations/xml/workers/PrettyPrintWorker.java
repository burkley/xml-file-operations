 ...
 *
 */
public class PrettyPrintWorker extends SwingWorker<String, String> {
	/**
	 * The name of this class.
	 */
	private static final String _className = PrettyPrintWorker.class.getName();
	/**
	 * JDK logger.
	 */
...
//			System.out.println(_className + ".PrettyPrintWorker(): c.getName() = " + c.getName());
		}
